...
var process1 = function () {
    return new Promise( function ( resolve ) {
        ...
        //console.log(argv.shift());
        //console.log(argv)
        var redCrw    = spawn(process.execPath,  ["redCrw.js", argv], {
            cwd: process.cwd(),
            env: process.env,
            detached: true
        });
...
var process2 = function () {
    return new Promise( function ( resolve ) {
        var argv =  process.argv;
        var redCrw    = spawn(process.execPath,  ["insertRedData.js", argv], {
            cwd: process.cwd(),
            env: process.env,
            detached: true
        });
...
var process3 = function () {
    return new Promise( function ( resolve ) {
        ...
        var argv =  process.argv;
        var redCrw    = spawn(process.execPath,  ["redCrwPost.js", argv], {
            cwd: process.cwd(),
            env: process.env,
            detached: true
        });
...
var process4 = function () {
    return new Promise( function ( resolve ) {
        ...
        var argv =  process.argv;
        var redCrw    = spawn(process.execPath,  ["insertRedDataPost.js", argv], {
            cwd: process.cwd(),
            env: process.env,
            detached: true
        });
...
var process5 = function () {
    return new Promise( function ( resolve ) {
        ...
        var argv =  process.argv;
        var redCrw    = spawn(process.execPath,  ["redCrwPostDetail.js", argv], {
            cwd: process.cwd(),
            env: process.env,
            detached: true
        });
