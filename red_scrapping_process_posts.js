...
var process1 = function () {
    return new Promise( function ( resolve ) {
        ...
        //console.log(argv.shift());
        //console.log(argv)
        var redCrw    = spawn(process.execPath,  ["red_posts_data__download_to_json.js", argv], {
            cwd: process.cwd(),
            env: process.env,
            detached: true
        });
...
var process2 = function () {
    return new Promise( function ( resolve ) {
        var argv =  process.argv;
        var redCrw    = spawn(process.execPath,  ["red_posts_data__insert_db.js", argv], {
            cwd: process.cwd(),
            env: process.env,
            detached: true
        });
...
var process3 = function () {
    return new Promise( function ( resolve ) {
        var argv =  process.argv;
        var redCrw    = spawn(process.execPath,  ["red_posts_data_usertinfo__insert_db.js", argv], {
            cwd: process.cwd(),
            env: process.env,
            detached: true
        });
...
var process4 = function () {
    return new Promise( function ( resolve ) {
        ...
        var argv =  process.argv;
        var redCrw    = spawn(process.execPath,  ["red_posts_detail__download_to_txt.js", argv], {
            cwd: process.cwd(),
            env: process.env,
            detached: true
        });
...
var process5 = function () {
    return new Promise( function ( resolve ) {
        ...
        var argv =  process.argv;
        var redCrw    = spawn(process.execPath,  ["red_posts__detail__insert_db.js", argv], {
            cwd: process.cwd(),
            env: process.env,
            detached: true
        });
